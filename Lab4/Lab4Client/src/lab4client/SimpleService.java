...
public class SimpleService {
    List<SimpleData> Select(SimpleData data) {
        String URL = "http://localhost:8080/Lab4/webresources/Metods/SelectData"; 
    ...
    String Insert(SimpleData data) {
        String URL = "http://localhost:8080/Lab4/webresources/Metods/InsertData"; 
        GenericType<String> type = new GenericType<String>() {}; 
        return SendMessage(URL, new String[] {"id", "fild1", "fild2", "fild3", "fild4"}, new String[] {data.getId(), data.getFild1() , data.getFild2() , data.getFild3() , data.getFild4()}).getEntity(type);
    } 
    
    String Update(SimpleData data) {
        String URL = "http://localhost:8080/Lab4/webresources/Metods/UpdateData"; 
        GenericType<String> type = new GenericType<String>() {}; 
        return SendMessage(URL, new String[] {"id", "fild1", "fild2", "fild3", "fild4"}, new String[] {data.getId(), data.getFild1() , data.getFild2() , data.getFild3() , data.getFild4()}).getEntity(type);
    } 
    
    String Delete(int id) {
        String URL = "http://localhost:8080/Lab4/webresources/Metods/DeleteData"; 
        GenericType<String> type = new GenericType<String>() {}; 
        return SendMessage(URL, new String[] {"id"}, new String[] {String.valueOf(id)}).getEntity(type);
    } 
