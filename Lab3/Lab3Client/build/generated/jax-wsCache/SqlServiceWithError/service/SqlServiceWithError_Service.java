 ...
 * 
 */
@WebServiceClient(name = "SqlServiceWithError", targetNamespace = "http://Service/", wsdlLocation = "http://localhost:8080/Lab3/SqlServiceWithError?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Lab3/SqlServiceWithError?wsdl");
